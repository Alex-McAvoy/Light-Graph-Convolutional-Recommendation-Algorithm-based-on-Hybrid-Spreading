...
from model.LightGCN.loss import BPRLoss
from utils.trans import getUserItemsDictByEdgeIndex
from utils.graph import convertAdjMatrixToEdgeIndex

def getValRecommendations(model: LightGCN, user_num: int, item_num: int, 
...
def calValLoss(model: LightGCN, user_num: int, item_num: int, val_edge_index: torch.Tensor, lambda_val: float) -> float:
    """
