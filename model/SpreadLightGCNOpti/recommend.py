...
# coding=utf-8
"""
@Description   扩散+嵌入优化的LightGCN方法推荐
@Author        Alex_McAvoy
...
from model.SpreadLightGCNOpti.model import getResourceMat
from utils.trans import getUserItemsDictByDataframe

def recommendForAllUser(F_new: np.ndarray, user_num:int, 
...
def recommendSpreadLightGCNOpti(user_num:int, item_num: int, 
    ...
    # 计算资源转移矩阵
    F_new = getResourceMat(user_num, item_num, rating_df, train_data_df, val_data_df, test_data_df, user_features_df, item_features_df)
    # 获取推荐字典
